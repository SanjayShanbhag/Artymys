                ...
                <div class="userData">
                    <div class="row">
                        ...
                        <div class="col-sm-5 col-lg-5 col-md-5">
                            <?php
                                $sql = "SELECT penName,descript,applaudsuser,censuresuser,followercount,emp,totalreads FROM blogsignup WHERE uid = '$uid'";
                                $result = $conn->query($sql);
                                $row = $result->fetch_assoc();
                                $penName = $row['penName'];
                                if($check1 == 1){
                            ...
                            ?>
                            <br>
                            <a href="updateprofile.php" class="bton center-block" style="width: 150px;">Update Account</a>
                        </div>
                                ...
                                if(isset($row['emp']) && !empty($row['emp'])){
                                    echo "<div class='row'>";
                                        ...
                                        echo "<div class='col-sm-9 col-lg-9 col-md-9'>";
                                            echo "<p style='text-align: justify;'>".$row['emp']."</p>";
                                        echo "</div>";
                                    echo "</div>";
                                }
                                echo "<div class='row'>";
