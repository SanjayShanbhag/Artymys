        	...
        	<div class="row">
        		...
        		<hr>
        			...
        			<a href="addcontent.php" style="text-decoration: none;"><img src="images/follow.png" style="width: 20px; height: 20px; margin-right: 5px;"/> Add Post </a>
      				<br><br>
        			<a style="text-decoration: none; cursor: pointer;" id="notifsbtn"><img src="images/notification.png" style="width: 20px; height: 20px; margin-right: 5px;"/> Notifications <span style="background-color: #4FC3F7; min-width: 20px; min-height: 10px; color: #FFFFFF; display: inline-block; border-radius: 3px;"> <?php echo $notno;?> </span></a>
                    <br><br>
        		...
        		<div class="col-lg-8 col-md-8 col-sm-8">
                    <br>
                    <?php
                        $sql = "SELECT * FROM wyri ORDER BY date1 DESC";
                        $result = $conn->query($sql);
                        while($row = $result->fetch_assoc()){
                            ...
                            echo "<a href='wyris.php?id=".$id."' style='text-decoration: none;'>";
                                echo "<div class='cont'>";
                                    if($row1['verified'] == 1){
                                        $check1 = 1;
                                    }else{
        ...
        <div id="overlay"></div>
            <div id="popup">
                <div class="notihead">
                    ...
                    <h2 style="text-align: center; color: #EEEEEE;">My Notifications</h2>
                </div>
                <br>
                    <div class="popupcontent">
                        ...
                        while($row=$result->fetch_assoc()){
                           ...
                           if($diff <= 24){
                            ...
                            $sql12 = "SELECT dp, verified FROM blogsignup WHERE uid = '$uid1'";
                                ...
                                ?>
                                    <div class="item">
                                        ...
                                        <span class="notify-badge1"><img src="images/verified1.png" style="width: 15px; height: 15px;"></span>
                                <?php
                            ...
                            ?>
                            <a href="mynotifs.php" style="text-align: center;">See All Notifications</a> 
                    </div>
            </div>
            <script type="text/javascript">
                ...
                var button = document.getElementById("notifsbtn");
                // Close Popup Event
