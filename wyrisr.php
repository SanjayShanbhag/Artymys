        	...
        	<div class="row">
        		...
        		<div class="col-lg-8 col-md-8 col-sm-8">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8 col-lg-8 col-md-8" style="height: 40px;">
                            <?php
                                $sql1 = "SELECT yes1,no1 FROM wyri WHERE id = '$id'";
                                $result1 = $conn->query($sql1);
                                $row1 = $result1->fetch_assoc();
                                $yes = $row1['yes1'];
                                $no = $row1['no1'];
                                ...
                                if($total != 0){
                                    if($yes != 0){
                                        ...
                                        $yesp = round($yesp,0);
                                        ?>
                                        <div class="yesp" style="background-color: #10E025; width: <?php echo $yesp;?>%; height: 100%; margin-left: 0; float: left; box-shadow: 4px 4px 4px #B9F6CA; border-top-left-radius: 5px; border-bottom-left-radius: 5px;">
                                                <?php
                                                    echo "<p style='text-align: center; margin-top: 7px; color: #263238;'>".$yesp."%</p>";
                                                ?>
                                        </div>
                                    <?php    
                                    }
                                    if($no != 0){
                                        ...
                                        $nop = round($nop,0);
                                        ?>
                                        <div class="nop" style="background-color: #FF2C00; width: <?php echo $nop;?>%; height: 100%; margin-left: 0px; float:right; box-shadow: 4px 4px 4px #FF9E80; border-top-right-radius: 5px; border-bottom-right-radius: 5px;">
                                            <?php
                                                echo "<p style='text-align: center; margin-top: 7px; color: #263238;'>".$nop."%</p>";
                                            ?>
                                        </div>
                                        <?php
                                    }
                                }else{
                                    echo "<h4>No Reactions Yet";
                                }
                    ...
                    <br>
                            <?php
                                $sql = "SELECT * FROM wyricomment WHERE contentid = '$id'";
                                $result = $conn->query($sql);
